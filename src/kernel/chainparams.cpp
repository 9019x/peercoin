...
{
    const char* pszTimestamp = "NYTimes 09-MAY-2025 TikTok Fined $600 Million for Sending European User Data to China";
...
*/
        ...
        vSeeds.emplace_back("dummy.invalidseed");
